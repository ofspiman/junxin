...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul>
    <li class="focus"><a href="<?php echo url('page/services/index'); ?>"><?php echo $services['name']; ?></a></li>
</ul>
    </div>
    ...
    <div class="detail">
        <div class="news_content">
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <li>
                    <a href="<?php echo url('services/detail',['id'=>$item['id']]); ?>">
