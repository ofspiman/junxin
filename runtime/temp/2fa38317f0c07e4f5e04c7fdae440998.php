...
<div class="content">
    ...
    <li <?php if($product['id']==$id): ?> class="focus" <?php endif; ?>>
        <a href="<?php echo url('page/product/index',['id'=>$product['id']]); ?>"><?php echo $product['name']; ?></a>
    </li>
</ul>
