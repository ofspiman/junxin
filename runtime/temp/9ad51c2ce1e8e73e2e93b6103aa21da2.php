...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul>
            <li class="focus"><a href="">贵金属知识</a></li>
        </ul>
    </div>
    ...
    <div class="detail">
        <div class="news_content">
            ...
            <li>
                <a href="<?php echo url('knolodeg/detail',['id'=>$item['id']]); ?>">
                    <?php echo $item['title']; ?>
                </a>
                <span><?php echo $item['time_text']; ?></span>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
