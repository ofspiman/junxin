define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'knolodeg/index' + location.search,
                    add_url: 'knolodeg/add',
                    edit_url: 'knolodeg/edit',
                    del_url: 'knolodeg/del',
                    multi_url: 'knolodeg/multi',
                    import_url: 'knolodeg/import',
                    table: 'knolodeg',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'knolodeg/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
